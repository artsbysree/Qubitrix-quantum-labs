...
const bellStates = [
  {
    name: "Bell State |Φ+⟩",
    desc: "Maximally entangled - both 0 or both 1",
    formula: "(|00⟩ + |11⟩)/√2",
  },
  {
    name: "Bell State |Φ-⟩",
    desc: "Maximally entangled with phase",
    formula: "(|00⟩ - |11⟩)/√2",
  },
  {
    name: "Bell State |Ψ+⟩",
    desc: "Maximally entangled - opposite states",
    formula: "(|01⟩ + |10⟩)/√2",
  },
  {
    name: "Bell State |Ψ-⟩",
...
export default function EntanglementLab() {
  ...
  const [results, setResults] = useState<{ qubit1: string; qubit2: string }>({
    qubit1: "",
    qubit2: "",
  });
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8 p-6 rounded-xl bg-primary/10 border border-primary/30">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Learn about quantum entanglement - a phenomenon where two qubits
              become correlated such that measuring one instantly affects the
              other. You'll create Bell states (maximally entangled states) and
              observe the quantum correlations that make entanglement so
              powerful.
            </p>
          </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="p-6 rounded-xl border border-border bg-card">
                ...
                <ol className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>
                      Notice that Qubit 2 is always correlated with Qubit 1
                    </span>
                  </li>
                  <li className="flex gap-3">
              ...
              <div className="p-6 rounded-xl border border-border bg-card">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  In an entangled state, measuring one qubit instantaneously
                  determines the outcome for the other, regardless of distance.
                  This "spooky action at a distance" is what Einstein famously
                  questioned!
                </p>
              </div>
            </div>
                ...
                {measurements.length === 0 ? (
                  <div className="flex items-center justify-center h-64 bg-background/50 rounded-lg border border-border">
                    <p className="text-muted-foreground text-center">
                      Perform measurements to see results
                    </p>
                  </div>
                ) : (
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-2 max-h-40 overflow-y-auto">
                        {measurements.slice(-10).map((m, idx) => (
                          <div
                            key={idx}
                            className="p-2 rounded bg-background/50 text-center font-mono text-sm text-primary"
                          >
                    ...
                    <div className="p-4 bg-primary/10 rounded-lg border border-primary/20">
                      ...
                      <p className="text-xs text-muted-foreground mb-3">
                        Perfect correlation - measuring one qubit determines the
                        other!
                      </p>
          ...
          <div className="bg-gradient-to-r from-primary/10 via-secondary/10 to-primary/10 rounded-xl border border-primary/30 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-muted-foreground">
                  Understand the four maximally entangled two-qubit states
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-foreground mb-2">
                ...
                <p className="text-muted-foreground">
                  See how measurements are perfectly correlated
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-foreground mb-2">
                ...
                <p className="text-muted-foreground">
                  Explore the mysterious nature of quantum entanglement
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-foreground mb-2">
                ...
                <p className="text-muted-foreground">
                  Learn why entanglement is a key quantum resource
                </p>
              </div>
            </div>
          </div>
